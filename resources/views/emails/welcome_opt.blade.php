                        ...
                        <tr>
                            <td class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                                ...
                                <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #475569">
                                    {{__("Bienvenue chez Thalia eats !")}} <br>
                                    {{__("Pour sécuriser votre compte et finaliser votre inscription, veuillez saisir le code de vérification (OTP) ci-dessous dans notre formulaire d'activation :")}}
                                </p>
                                <h3 style="margin: 0 0 16px">
                                    {{__("Votre code d'authentification :")}}
                                </h3>
                                <div>
                                ...
                                <p class="mso-break-all" style="margin: 0; font-size: 12px; line-height: 20px; color: #475569">
                                    {{__("Si vous n'avez pas demandé d'activation, ignorez simplement cet e-mail ou contactez notre équipe d'assistance.")}}
                                </p>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td class="sm-px-6" style="padding: 24px 36px">
                                <p style="margin: 0; font-size: 12px; color: #64748b">
                                    &copy; 2025 Thalia eats. All rights reserved.
                                </p>
                            </td>
                        </tr>
                    </table>
