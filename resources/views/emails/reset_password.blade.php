                    ...
                    <table style="width: 100%" cellpadding="0" cellspacing="0" role="none">
                        <tr>
                            <td class="sm-p-6" style="border-radius: 8px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #e2e8f0">
                                <a href="https://connectrdc.sims-opportunity.com">
                                    <img src="https://connectrdc.sims-opportunity.com/logo_gradient.svg" width="170" alt style="max-width: 100%; vertical-align: middle">
                                </a>
                                <div role="separator" style="line-height: 24px">&zwj;</div>
                                ...
                                <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #475569">
                                    {{__("Password reset")}} <br>
                                    {{__("For reset your password, please enter the verification code (OTP) below in our activation form:")}}
                                </p>
                                <h3 style="margin: 0 0 16px">
                                    {{__("Your verification code :")}}
                                </h3>
                                <div>
                                    <a href="#" style="display: inline-block; text-decoration: none; padding: 16px 24px; font-size: 16px; line-height: 1; border-radius: 4px; color: #fffffe; background-color: #020617" class="hover-bg-slate-800">
                                        <!--[if mso]><i style="mso-font-width: 150%; mso-text-raise: 31px" hidden>&emsp;</i><![endif]-->
                                        <span style="mso-text-raise: 16px">{{$otp}}</span>
                                ...
                                <p style="margin: 0; font-size: 16px; line-height: 24px; color: #475569">
                                    Thanks,
                                    <br>
                                    <span style="font-weight: 600">Connect RDC</span>
                                </p>
                                ...
                                <p class="mso-break-all" style="margin: 0; font-size: 12px; line-height: 20px; color: #475569">
                                    {{__("If you have not requested activation, simply ignore this email or contact our support team.")}}
                                </p>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td class="sm-px-6" style="padding: 24px 36px">
                                <p style="margin: 0; font-size: 12px; color: #64748b">
                                    &copy; 2025 Connect RDC. All rights reserved.
                                </p>
                            </td>
                        </tr>
                    </table>
